            ...
            :
                <div className='w-80 space-y-8'>
                    <div className='space-y-3'>
                        ...
                        <p className='text-gray-500 text-xs break-words text-center select-none'>
                            Check your email for a <span className='text-gray-400'>password-reset link</span>. Clicking this link will open PrivaNote and prompt for a new password.
                        </p>
                    </div>
                    <div className='flex justify-end items-center space-x-2'>
                        <button
                            onClick={ () => modalManagerDispatch({type: 'forgotPasswordModal', forgotPasswordModalVisible: false }) }
                            className='pn-button bg-blue-500 bg-opacity-50 border-blue-500 hover:border-blue-400'
                        >
                            Ok
                        </button>
